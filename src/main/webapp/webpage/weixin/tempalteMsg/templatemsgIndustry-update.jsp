...
<html>
 ...
 <body>
  <t:formvalid formid="formobj" dialog="true" usePlugin="password" layout="table" action="weixinTemplatemsgIndustryController.do?doUpdate" tiptype="1">
					...
					<tr>
						...
						<td class="value">
						     	 <input id="nameOneFirst" name="nameOneFirst" type="text" style="width: 150px" class="inputxt"  
										       ...
										       value='${weixinTemplatemsgIndustryPage.nameOneFirst}'>
					...
					<tr>
						...
						<td class="value">
						     	 <input id="nameOneSecond" name="nameOneSecond" type="text" style="width: 150px" class="inputxt"  
										       ...
										       value='${weixinTemplatemsgIndustryPage.nameOneSecond}'>
							<span class="Validform_checktip"></span>
					...
					<tr>
						...
						<td class="value">
						     	 <input id="codeOne" name="codeOne" type="text" style="width: 150px" class="inputxt"  
										       ...
										       value='${weixinTemplatemsgIndustryPage.codeOne}'>
							<span class="Validform_checktip"></span>
					...
					<tr>
						...
						<td class="value">
						     	 <input id="nameTwoFirst" name="nameTwoFirst" type="text" style="width: 150px" class="inputxt"  
										       ...
										       value='${weixinTemplatemsgIndustryPage.nameTwoFirst}'>
							<span class="Validform_checktip"></span>
					...
					<tr>
						...
						<td class="value">
						     	 <input id="nameTwoSecond" name="nameTwoSecond" type="text" style="width: 150px" class="inputxt"  
										       ...
										       value='${weixinTemplatemsgIndustryPage.nameTwoSecond}'>
							<span class="Validform_checktip"></span>
					...
					<tr>
						...
						<td class="value">
						     	 <input id="codeTwo" name="codeTwo" type="text" style="width: 150px" class="inputxt"  
										       ...
										       value='${weixinTemplatemsgIndustryPage.codeTwo}'>
							<span class="Validform_checktip"></span>
