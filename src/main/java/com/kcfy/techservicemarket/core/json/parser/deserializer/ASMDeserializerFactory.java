...
import static com.kcfy.techservicemarket.core.json.util.ASMUtils.getDesc;
import static com.kcfy.techservicemarket.core.json.util.ASMUtils.getType;
...
import com.kcfy.techservicemarket.core.json.asm.ClassWriter;
import com.kcfy.techservicemarket.core.json.asm.FieldVisitor;
import com.kcfy.techservicemarket.core.json.asm.Label;
import com.kcfy.techservicemarket.core.json.asm.MethodVisitor;
import com.kcfy.techservicemarket.core.json.asm.Opcodes;
...
import com.kcfy.techservicemarket.core.json.parser.ParseContext;
import com.kcfy.techservicemarket.core.json.parser.ParserConfig;
import com.kcfy.techservicemarket.core.json.parser.SymbolTable;
import com.kcfy.techservicemarket.core.json.parser.deserializer.ASMJavaBeanDeserializer.InnerJavaBeanDeserializer;
...
public class ASMDeserializerFactory implements Opcodes {
    ...
    private void _deserialze_list_obj(Context context, MethodVisitor mw, Label reset_, FieldInfo fieldInfo,
        ...
        mw.visitLdcInsn(com.kcfy.techservicemarket.core.json.asm.Type.getType(getDesc(itemType)));
    ...
    private void _deserialze_obj(Context context, MethodVisitor mw, Label reset_, FieldInfo fieldInfo,
        ...
        mw.visitMethodInsn(INVOKEVIRTUAL, getType(DefaultJSONParser.class), "getConfig", "()"
                                                                                         + getDesc(ParserConfig.class));
        mw.visitLdcInsn(com.kcfy.techservicemarket.core.json.asm.Type.getType(getDesc(fieldInfo.getFieldClass())));
        mw.visitMethodInsn(INVOKEVIRTUAL, getType(ParserConfig.class), "getDeserializer",
                           "(" + getDesc(Type.class) + ")" + getDesc(ObjectDeserializer.class));
